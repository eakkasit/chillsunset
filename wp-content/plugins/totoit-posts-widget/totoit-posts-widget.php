 ...
 *
 * @package           DPE_TOTOIT_Posts_Widget
 * @author            TOTOIT <contact@totoit.co.th>
 * @license           GPL-2.0+
 * @link              http://totoit.co.th
 * @copyright         2017 - 2018 TOTOIT
 *
 * @wordpress-plugin
 * Plugin Name:       TOTOIT Posts Widget
 * Plugin URI:        http://totoit.co.th
 ...
 * Version:           1.0
 * Author:            TOTOIT
 * Author URI:        http://totoit.co.th
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain:       totoit-posts-widget
 ...
 * TOTOIT CO. LTD 288/22 Moo 8, Nongjom, San Sai, Chiang Mai 50210
 */
...
if ( ! class_exists( 'FPW_Plugin' ) ) {
	...
	/**
	 * TOTOIT Posts Widgets Plugin Class
	 *
	...
	class FPW_Plugin {
		...
		public function register_widgets() {
			...
			register_widget( 'TOTOIT_Posts_Widget' );
		}
